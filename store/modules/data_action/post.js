...
exports.getLevelData =
  exports.postLevelData =
  exports.levelFetchDataFailure =
  exports.levelFetchDataSuccess =
  exports.levelFetchDataRequest =
  exports.postReducer =
  exports.initalLevelState =
  exports.FETCH_LEVEL_DATA_FAILURE =
  exports.FETCH_LEVEL_DATA_SUCCESS =
  exports.FETCH_LEVEL_DATA_REQUEST =
    void 0;
...
const postLevelData = (sendData) => {
  ...
  // axios.defaults.xsrfHeaderName = "X-CSRFToken"
  axios_1.default.defaults.headers.common["X-Requested-With"] =
    "XMLHttpRequest";
  const headers = {
    "Access-Control-Allow-Orgin": "*",
    "Content-Type": "application/json; charset=utf-8",
