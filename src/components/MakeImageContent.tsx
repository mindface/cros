   ...
   <div className="make-image">
     <div className="make-image--inner">
       ...
       <div id="html2canvas" className='html2canvas' ref={forhtml2canvas}>
        { iamgeSrcOb.iamge01Src !== "" && <img src={iamgeSrcOb.iamge01Src} className="bg-img" alt="" /> }
        <div className="face">
          <h3 className="title">MakeImageContent</h3>
          <div className="items d-f">
            <div className="item">
              <div className="text" contentEditable={true} suppressContentEditableWarning >調整への構成</div>
            </div>
            <input type="file" name="" id="iamge02" className="d-n" onChange={(e) => {setImageUrl(e,2)}} />
            <div className="item">
              <div className="img-box min-img">
              { iamgeSrcOb.iamge02Src !== "" ? <img src={iamgeSrcOb.iamge02Src} className="img" alt="" /> : <label htmlFor="iamge02" className="label">画像を選択</label> }
              </div>
            </div>
          </div>
          <div className="items d-f reverce">
            <div className="item">
              <div className="text" contentEditable={true} suppressContentEditableWarning >
                画像とデザインの作成を
              </div>
            </div>
            <div className="item">
              <input type="file" name="" id="iamge03" className="d-n" onChange={(e) => {setImageUrl(e,3)}} />
              <div className="img-box base-img">
              { iamgeSrcOb.iamge03Src !== "" ? <img src={iamgeSrcOb.iamge03Src} className="img" alt="" /> : <label htmlFor="iamge03" className="label">画像を選択</label> }
              </div>
            </div>
          </div>
        </div>
