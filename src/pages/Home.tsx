    ...
    <div className="content">
      <div className="content--inner">
        <h3 className="content__title">
          {texts.map((item,index) => (<span className="aid" key={index} style={{animationDelay:`${0.3*index}s`}}>{item}</span>))}
        </h3>
        <div className="content__body">
          <div className="link-box radius">
            <Link className="link" to="/about"><span className="aid">about</span>
              <p className="text">わたしたちについて</p>
            </Link>
          </div>
          <div className="link-box radius">
            <Link className="link" to="/make"><span className="aid">make</span>
