      ...
      <div className="make-image--inner">
        <div className="make-btns pb-10">
          ...
          <div className="svg-box">
            <svg
              id="rect"
              className={selctSvg === "rect" ? "active svg" : "svg"}
              ref={forSvg}
              onClick={() => selectAction("rect")}
              width="50"
              height="50"
              version="1.1"
            ...
            <svg
              id="circle"
              className={selctSvg === "circle" ? "active svg" : "svg"}
              ref={forSvg}
              onClick={() => selectAction("circle")}
              width="50"
              height="50"
              version="1.1"
              xmlns="http://www.w3.org/2000/svg"
            ...
            <svg
              id="path"
              className={selctSvg === "path" ? "active svg" : "svg"}
              ref={forSvg}
            ...
            <button className="btn" onClick={() => selectAddAction()}>
              svg 追加
            </button>
            <button
              className="btn"
