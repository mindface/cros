  ...
  function selectAddAction() {
    switch (selctSvg) {
      case "text":
        ...
        { left: 10, top: 10, fill: textColor.current, fontFamily: 'Helvetica', lineHeight: 1.1,
          styles: {
            0: {
     ...
     <div className="make-image--inner">
       <div className="make-btns pb-10">
         ...
         <div className="svg-box">
          ...
          <button className='btn' onClick={() => selectAddAction()}>svg 追加</button>
          ...
          <label className='btn'>テキスト色を選択 <input type="color" value="#0000ff" onChange={(e:React.ChangeEvent<HTMLInputElement>) => selectColorAction(e)} /></label>
          <label htmlFor="add_photo" className="label btn">photo add</label>
          <button className='btn' onClick={() => objDeleteAction()}>select delete</button>
         </div>
       </div>
